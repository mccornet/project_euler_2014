...
forming a chain of two numbers. For this reason, 220 and 284 
...
Since this chain returns to its starting point, 
it is called an amicable chain.

Find the smallest member of the longest amicable 
chain with no element exceeding one million.
"""

# answer found in 'http://www.amazon.com/Recreations-Theory-Numbers-Dover-Recreational/dp/0486210960'